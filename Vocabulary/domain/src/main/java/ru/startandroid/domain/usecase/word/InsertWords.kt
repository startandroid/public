...
class InsertWords(val wordRepository: WordRepository): CompletableUseCaseWithParameter<List<Word>>() {

    override fun createObservable(words: List<Word>): Completable = wordRepository.insertWords(words)
